...
{
    public class BladeOfGrassProj : ModProjectile
    {
       ...
       public override void OnSpawn(IEntitySource source)
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, new Vector2(Angle), ProjectileID.BladeOfGrass, Projectile.damage / 6, 0.1f);
                Angle += 40 ;
            }
        }
    }
