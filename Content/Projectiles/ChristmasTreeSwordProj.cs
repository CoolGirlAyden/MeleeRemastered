...
{
    public class ChristmasTreeSwordProj : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.height = 60; // Hitbox height of projectileS
        ...
        private void ExecuteStrike()
        {
            ...
            if (i == 3)
            {
                for (int i = 0; i < Power; i++)
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(5 * Owner.direction, Main.rand.Next(-7, 7)) , ProjectileID.OrnamentFriendly, Projectile.damage, 0.4f); 
            }
            if (Timer >= 5)
            {
