    ...
    public class ChlorophyteSaberProj : ModProjectile
    {
        ...
        private void ExecuteStrike()
        {
            ...
            if (i == 1)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(5 * Owner.direction, Main.rand.Next(-7, 7)), ProjectileID.SporeCloud, Projectile.damage / 2, 0.1f);
                }
            }
