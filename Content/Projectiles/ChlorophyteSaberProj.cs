...
{
    public class ChlorophyteSaberProj : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.height = 46; // Hitbox height of projectileS
       ...
       public override void OnSpawn(IEntitySource source)
        ...
        private void ExecuteStrike()
        {
            ...
            if (i == 1)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, (Projectile.DirectionTo(Main.MouseWorld) * 8).RotatedByRandom(MathHelper.ToRadians(45)), ProjectileID.SporeCloud, Projectile.damage / 2, 0.1f);
                }
            }
