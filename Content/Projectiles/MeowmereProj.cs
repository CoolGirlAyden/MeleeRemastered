...
{
    public class MeowmereProj : ModProjectile
    {
       ...
       public override void OnSpawn(IEntitySource source)
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, new Vector2(5 * Owner.direction, Main.rand.Next(-7, 7)), ProjectileID.Meowmere, Projectile.damage / 2, 0.1f);
            }
        }
    }
}