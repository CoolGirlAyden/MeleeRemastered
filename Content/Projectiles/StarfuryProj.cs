...
{
    public class StarfuryProj : ModProjectile
    {
        ...
        {
            Projectile.width = 42; // Hitbox width of projectile
            Projectile.height = 42; // Hitbox height of projectileS
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < (int)Power; i++)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), pos, pos.DirectionTo(target.Center) * 24, ProjectileID.Starfury, Projectile.damage / 6, Projectile.knockBack, Projectile.owner, 0, target.Center.Y);
                pos = target.Center;
            }
        }
    }
