...
{
    public class ChlorophyteClaymoreProj : ModProjectile
    {
       ...
       public override void OnSpawn(IEntitySource source)
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, new Vector2(2 * Main.rand.Next(-4, 4), 2 * Main.rand.Next(-4, 4)), ProjectileID.ChlorophyteOrb, Projectile.damage, Projectile.knockBack);
            }
        }
    }
}