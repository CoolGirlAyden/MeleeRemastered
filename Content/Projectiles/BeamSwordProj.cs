...
namespace MeleeRemastered.Content.Projectiles
{
    public class BeamSwordProj : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.height = 52; // Hitbox height of projectileS
       ...
       public override void OnSpawn(IEntitySource source)
        ...
        private void PrepareStrike()
        {
            if (Timer < 180)
            {
                ...
                Size = MathHelper.SmoothStep(0.2f, 1.2f, Timer / 180); // Make sword slowly increase in size as we prepare to strike until it reaches max
        ...
        private void ExecuteStrike()
        {
            ...
            if (i == 1)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, (Projectile.DirectionTo(Main.MouseWorld) * 8).RotatedByRandom(MathHelper.ToRadians(45)), ProjectileID.SwordBeam, Projectile.damage / 2, 0.1f);
                }
            }
