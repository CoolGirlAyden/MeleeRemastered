...
{
    public class IceSickleProj : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.height = 44; // Hitbox height of projectileS
       ...
       public override void OnSpawn(IEntitySource source)
        ...
        private void ExecuteStrike()
        {
            ...
            Progress = MathHelper.SmoothStep(0, SWINGRANGE, (1f - UNWIND) * Timer / 5);if (Timer == 3)
                if (Timer == 3)
                for (int i = 0; i < Power; i++)
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, (Projectile.DirectionTo(Main.MouseWorld) * 8).RotatedByRandom(MathHelper.ToRadians(45)), ProjectileID.IceSickle, Projectile.damage / 2, 0.4f);
            if (Timer >= 5)
            {
