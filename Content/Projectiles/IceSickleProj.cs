       ...
       public override void OnSpawn(IEntitySource source)
        ...
        private void ExecuteStrike()
        {
            ...
            Progress = MathHelper.SmoothStep(0, SWINGRANGE, (1f - UNWIND) * Timer / 5);if (Timer == 3)
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(5 * Owner.direction, Main.rand.Next(-7, 7)) , ProjectileID.IceSickle, Projectile.damage / 2, 0.4f);
            if (Timer >= 5)
            {
