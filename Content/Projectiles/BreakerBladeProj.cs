...
{
    public class BreakerBladeProj : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.height = 92; // Hitbox height of projectileS
        ...
        private void PrepareStrike()
        {
            if (Timer < 180)
            {
                ...
                Size = MathHelper.SmoothStep(0.6f, 1.6f, Timer / 180); // Make sword slowly increase in size as we prepare to strike until it reaches max
