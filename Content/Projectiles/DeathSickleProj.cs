       ...
       public override void OnSpawn(IEntitySource source)
        ...
        private void ExecuteStrike()
        {
            ...
            if (Timer == 3)
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(5 * Owner.direction, Main.rand.Next(-7, 7)) , ProjectileID.DeathSickle, Projectile.damage / 2, 0.4f);
            if (Timer >= 5)
            {
