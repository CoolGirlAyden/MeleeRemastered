...
{
    public class DeathSickleProj : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.height = 64; // Hitbox height of projectileS
       ...
       public override void OnSpawn(IEntitySource source)
        ...
        private void ExecuteStrike()
        {
            ...
            if (Timer == 3)
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, (Projectile.DirectionTo(Main.MouseWorld) * 8).RotatedByRandom(MathHelper.ToRadians(45)) , ProjectileID.DeathSickle, Projectile.damage / 2, 0.4f);
            if (Timer >= 5)
            {
