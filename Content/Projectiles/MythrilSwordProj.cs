...
{
    public class MythrilSwordProj : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, Vector2.Zero, ProjectileID.CrystalLeafShot, Projectile.damage, 0);
        }
    }
}