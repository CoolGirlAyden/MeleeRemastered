...
{
    public class SeedlerProj : ModProjectile
    {
        ...
        {
            Projectile.width = 44; // Hitbox width of projectile
            Projectile.height = 68; // Hitbox height of projectileS
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center, new Vector2(2 * Main.rand.Next(-4, 4), -4), ProjectileID.SeedlerNut, Projectile.damage, Projectile.knockBack);
            }
        }
    }
}