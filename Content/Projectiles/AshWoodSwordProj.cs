...
{
    public class AshWoodSwordProj : ModProjectile
    {
        ...
        private void PrepareStrike()
        {
            if (Timer < 180)
            {
                ...
                Size = MathHelper.SmoothStep(0.2f, 1, Timer / 180); // Make sword slowly increase in size as we prepare to strike until it reaches max
